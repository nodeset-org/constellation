...
> [!WARNING]
> Unfortunately, the Rocket Pool community decided to break compatibility with the interfaces used in this project, so Constellation's contracts will no longer work without major changes. Based on this (and a lack of demand for Rocket Pool's rETH preventing the growth of any Constellation deployment), this project was fully deprecated in mid 2025. DO NOT contact NodeSet about bugs or issues with any deployment of Constellation! NodeSet now provides decentralized Ethereum staking services via the StakeWise platform instead.
...
> [!TIP]  
> The `audits` directory contains all the third-party security reviews completed for the code in this repository.
