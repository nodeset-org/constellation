...
contract DepositPool is Base {
    ...
    string constant public ONLY_ETH_TOKEN_ERROR = "DepositPool: This function may only be called by the yaspETH token contract";
    string constant public ONLY_RPL_TOKEN_ERROR = "DepositPool: This function may only be called by the yaspRPL token contract";
