...
contract RocketMinipoolManager is RocketBase, RocketMinipoolManagerInterface {
    ...
    function getMinipoolCount() public view override returns (uint256) {
    ...
    function getMinipoolRPLSlashed(address _minipoolAddress) external view override returns (bool) {
        ...
        )
    {
        ...
        if (max > totalMinipools || _limit == 0) {
            max = totalMinipools;
        }
    ...
    function getPrelaunchMinipools(uint256 _offset, uint256 _limit) external view override returns (address[] memory) {
        // Get contracts
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        );
    ...
    function getNodeMinipoolCount(address _nodeAddress) external view override returns (uint256) {
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        );
    ...
    function getNodeActiveMinipoolCount(address _nodeAddress) public view override returns (uint256) {
        RocketNetworkSnapshots rocketNetworkSnapshots = RocketNetworkSnapshots(
    ...
    function getNodeFinalisedMinipoolCount(address _nodeAddress) external view override returns (uint256) {
    ...
    function getNodeStakingMinipoolCount(address _nodeAddress) public view override returns (uint256) {
    ...
    function getNodeStakingMinipoolCountBySize(
    ...
    function getNodeMinipoolAt(address _nodeAddress, uint256 _index) external view override returns (address) {
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        );
    ...
    function getNodeValidatingMinipoolCount(address _nodeAddress) external view override returns (uint256) {
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        );
    ...
    function getNodeValidatingMinipoolAt(
        ...
        return
            addressSetStorage.getItem(
                keccak256(abi.encodePacked('node.minipools.validating.index', _nodeAddress)),
                _index
            );
    }
    ...
    function getMinipoolByPubkey(bytes memory _pubkey) public view override returns (address) {
    ...
    function getMinipoolExists(address _minipoolAddress) public view override returns (bool) {
    ...
    function getMinipoolDestroyed(address _minipoolAddress) external view override returns (bool) {
    ...
    function getMinipoolPubkey(address _minipoolAddress) public view override returns (bytes memory) {
    ...
    function getMinipoolWithdrawalCredentials(address _minipoolAddress) public pure override returns (bytes memory) {
    ...
    function updateNodeStakingMinipoolCount(
        uint256 _previousBond,
        uint256 _newBond,
        uint256 _previousFee,
        uint256 _newFee
    ) external override onlyLatestContract('rocketMinipoolManager', address(this)) onlyRegisteredMinipool(msg.sender) {
        bytes32 nodeKey;
    ...
    function tryDistribute(address _nodeAddress) external override {
        _tryDistribute(_nodeAddress);
    }
    ...
    function createMinipool(
        ...
        public
        override
        onlyLatestContract('rocketMinipoolManager', address(this))
        onlyLatestContract('rocketNodeDeposit', msg.sender)
        returns (RocketMinipoolInterface)
    {
        // Load contracts
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        ...
        // Check node minipool limit based on RPL stake
        {
            ...
            require(
                totalMinipoolCount + 1 <= rocketDAOProtocolSettingsMinipool.getMaximumCount(),
    ...
    function getVacantMinipoolCount() external view override returns (uint256) {
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        );
    ...
    function getVacantMinipoolAt(uint256 _index) external view override returns (address) {
        AddressSetStorageInterface addressSetStorage = AddressSetStorageInterface(
            getContractAddress('addressSetStorage')
        );
    ...
    ) public override onlyLatestContract('rocketMinipoolManager', address(this)) onlyRegisteredMinipool(msg.sender) {
    ...
    function _setMinipoolPubkey(address _minipool, bytes calldata _pubkey) private {
        ...
        addressSetStorage.addItem(
            keccak256(abi.encodePacked('node.minipools.validating.index', nodeAddress)),
            _minipool
        );
    }
    ...
    function getMinipoolDepositType(address _minipoolAddress) external view override returns (MinipoolDeposit) {
    ...
    function deployContract(address _nodeAddress, uint256 _salt) private returns (address) {
        RocketMinipoolFactoryInterface rocketMinipoolFactory = RocketMinipoolFactoryInterface(
            getContractAddress('rocketMinipoolFactory')
        );
