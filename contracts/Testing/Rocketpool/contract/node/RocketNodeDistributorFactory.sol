...
contract RocketNodeDistributorFactory is RocketBase, RocketNodeDistributorFactoryInterface {
    ...
    function getProxyBytecode() public pure override returns (bytes memory) {
    ...
    function getProxyAddress(address _nodeAddress) external view override returns (address) {
    ...
    function createProxy(address _nodeAddress) external override onlyLatestContract('rocketNodeManager', msg.sender) {
