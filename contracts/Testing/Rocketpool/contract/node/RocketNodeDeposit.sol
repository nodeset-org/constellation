...
contract RocketNodeDeposit is RocketBase, RocketNodeDepositInterface, RocketVaultWithdrawerInterface {
    ...
    function increaseDepositCreditBalance(
        ...
        uint256 _amount
    ) external override onlyLatestContract('rocketNodeDeposit', address(this)) onlyRegisteredNode(_nodeAddress) {
    ...
    function depositEthFor(
        ...
        payable
        override
        onlyLatestContract('rocketNodeDeposit', address(this))
    ...
    function withdrawEth(
        address _nodeAddress,
        uint256 _amount
    ) external onlyLatestContract('rocketNodeDeposit', address(this)) onlyRegisteredNode(_nodeAddress) {
        // Check valid caller
