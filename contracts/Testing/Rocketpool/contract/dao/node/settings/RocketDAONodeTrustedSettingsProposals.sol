...
contract RocketDAONodeTrustedSettingsProposals is
    ...
    RocketDAONodeTrustedSettingsProposalsInterface
{
    ...
    ) RocketDAONodeTrustedSettings(_rocketStorageAddress, 'proposals') {
        // Set version
        version = 1;
    ...
    function getCooldownTime() external view override returns (uint256) {
