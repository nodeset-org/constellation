...
contract RocketDAONodeTrusted is RocketBase, RocketDAONodeTrustedInterface {
    ...
    function getMemberRPLBondAmount(address _nodeAddress) external view override returns (uint256) {
    ...
    function incrementMemberUnbondedValidatorCount(
        address _nodeAddress
    )
        external
        override
    ...
    function decrementMemberUnbondedValidatorCount(
        address _nodeAddress
    ) external override onlyLatestContract('rocketDAONodeTrusted', address(this)) onlyRegisteredMinipool(msg.sender) {
