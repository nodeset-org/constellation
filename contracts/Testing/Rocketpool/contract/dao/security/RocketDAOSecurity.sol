...
contract RocketDAOSecurity is RocketBase, RocketDAOSecurityInterface {
    ...
    function getMemberIsValid(address _memberAddress) external view override returns (bool) {
    ...
    function getMemberID(address _memberAddress) external view override returns (string memory) {
    ...
    function getMemberJoinedTime(address _memberAddress) external view override returns (uint256) {
    ...
    function getMemberProposalExecutedTime(
        ...
        return
            getUint(keccak256(abi.encodePacked(daoNameSpace, 'member.executed.time', _proposalType, _memberAddress)));
    }
}
