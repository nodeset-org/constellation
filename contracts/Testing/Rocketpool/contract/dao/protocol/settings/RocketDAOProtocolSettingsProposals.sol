...
contract RocketDAOProtocolSettingsProposals is RocketDAOProtocolSettings, RocketDAOProtocolSettingsProposalsInterface {
    ...
    ) RocketDAOProtocolSettings(_rocketStorageAddress, 'proposals') {
        version = 1;
    ...
    function getProposalBond() external view override returns (uint256) {
    ...
    function getChallengePeriod() external view override returns (uint256) {
    ...
    function getProposalQuorum() external view override returns (uint256) {
    ...
    function getProposalVetoQuorum() external view override returns (uint256) {
        return getSettingUint('proposal.veto.quorum');
    }

    /// @notice The maximum time in the past (in blocks) a proposal can be submitted for
    function getProposalMaxBlockAge() external view override returns (uint256) {
