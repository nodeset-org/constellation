...
contract RocketDAOProtocolSettingsNode is RocketDAOProtocolSettings, RocketDAOProtocolSettingsNodeInterface {
    ...
    function getSmoothingPoolRegistrationEnabled() external view override returns (bool) {
    ...
    function getVacantMinipoolsEnabled() external view override returns (bool) {
