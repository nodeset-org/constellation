...
contract RocketDAOProtocolProposals is RocketBase, RocketDAOProtocolProposalsInterface {
    ...
    event ProposalSettingRewardsClaimers(
        uint256 trustedNodePercent,
    ...
    modifier onlyExecutingContracts() {
        ...
        require(
            msg.sender == getContractAddress('rocketDAOProtocol') ||
                msg.sender == getContractAddress('rocketDAOProtocolProposal'),
    ...
    function proposalSettingRewardsClaimers(
    ...
    function proposalTreasuryOneTimeSpend(
    ...
    function proposalTreasuryNewContract(
    ...
    function proposalTreasuryUpdateContract(
        string memory _contractName,
        address _recipientAddress,
        uint256 _amountPerPeriod,
        uint256 _periodLength,
        ...
        RocketClaimDAOInterface rocketDAOTreasury = RocketClaimDAOInterface(getContractAddress('rocketClaimDAO'));
        rocketDAOTreasury.updateContract(
            _contractName,
            _recipientAddress,
            _amountPerPeriod,
            _periodLength,
    ...
    function proposalSecurityInvite(
        string calldata _id,
        address _memberAddress
    ) external override onlyExecutingContracts {
        RocketDAOSecurityProposalsInterface rocketDAOSecurityProposals = RocketDAOSecurityProposalsInterface(
            getContractAddress('rocketDAOSecurityProposals')
        );
    ...
    function proposalSecurityKick(address _memberAddress) external override onlyExecutingContracts {
        RocketDAOSecurityProposalsInterface rocketDAOSecurityProposals = RocketDAOSecurityProposalsInterface(
            getContractAddress('rocketDAOSecurityProposals')
        );
    ...
    function proposalSecurityKickMulti(address[] calldata _memberAddresses) external override onlyExecutingContracts {
        RocketDAOSecurityProposalsInterface rocketDAOSecurityProposals = RocketDAOSecurityProposalsInterface(
            getContractAddress('rocketDAOSecurityProposals')
        );
    ...
    function proposalSecurityReplace(
