...
contract RocketDAOProtocolProposal is RocketBase, RocketDAOProtocolProposalInterface {
    ...
    string internal constant daoProposalNameSpace = 'dao.protocol.proposal.';
    ...
    function propose(
        ...
        onlyLatestContract('rocketDAOProtocolProposal', address(this))
        returns (uint256)
    {
        ...
        RocketDAOProtocolVerifierInterface rocketDAOProtocolVerifier = RocketDAOProtocolVerifierInterface(
    ...
    ) external onlyRegisteredNode(msg.sender) onlyLatestContract('rocketDAOProtocolProposal', address(this)) {
        // Check valid vote
    ...
    function overrideVote(
        uint256 _proposalID,
        VoteDirection _voteDirection
    ) external override onlyRegisteredNode(msg.sender) onlyLatestContract('rocketDAOProtocolProposal', address(this)) {
        // Check valid vote
        require(_voteDirection != VoteDirection.NoVote, 'Invalid vote');
        // Check the proposal is in a state that can be voted on
    ...
    function finalise(
        uint256 _proposalID
    ) external override onlyLatestContract('rocketDAOProtocolProposal', address(this)) {
        // Check state
    ...
    function execute(
        ...
        require(
            getState(_proposalID) == ProposalState.Succeeded,
    ...
    function destroy(
        ...
        override
        onlyLatestContract('rocketDAOProtocolProposal', address(this))
        onlyLatestContract('rocketDAOProtocolVerifier', msg.sender)
    {
        // Cancel the proposal
    ...
    function getProposalBlock(uint256 _proposalID) public view override returns (uint256) {
    ...
    function getProposalVetoQuorum(uint256 _proposalID) external view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getProposer(uint256 _proposalID) public view override returns (address) {
        return getAddress(keccak256(abi.encodePacked(daoProposalNameSpace, 'proposer', _proposalID)));
    }

    /// @notice Get the proposal message
    /// @param _proposalID The ID of the proposal to query
    function getMessage(uint256 _proposalID) external view override returns (string memory) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getStart(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getPhase1End(uint256 _proposalID) public view override returns (uint256) {
    ...
    function getPhase2End(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getExpires(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getCreated(uint256 _proposalID) external view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getVotingPowerFor(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getVotingPowerAgainst(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getVotingPowerVeto(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getVotingPowerAbstained(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getVotingPowerRequired(uint256 _proposalID) public view override returns (uint256) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getDestroyed(uint256 _proposalID) public view override returns (bool) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getFinalised(uint256 _proposalID) external view override returns (bool) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getExecuted(uint256 _proposalID) public view override returns (bool) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getVetoQuorum(uint256 _proposalID) public view override returns (uint256) {
        return getUint(keccak256(abi.encodePacked(daoProposalNameSpace, 'proposal.veto.quorum', _proposalID)));
    }

    /// @notice Get the veto status of this proposal
    /// @param _proposalID The ID of the proposal to query
    function getVetoed(uint256 _proposalID) public view override returns (bool) {
    ...
    /// @param _proposalID The ID of the proposal to query
    function getPayload(uint256 _proposalID) public view override returns (bytes memory) {
    ...
    function getReceiptHasVoted(uint256 _proposalID, address _nodeAddress) public view override returns (bool) {
    ...
    /// @param _proposalID The ID of the proposal to query
    /// @param _nodeAddress The node operator address to query
    function getReceiptDirection(
        uint256 _proposalID,
        address _nodeAddress
    ) public view override returns (VoteDirection) {
        return
            VoteDirection(
                getUint(
                    keccak256(abi.encodePacked(daoProposalNameSpace, 'receipt.direction', _proposalID, _nodeAddress))
                )
            );
    }
    ...
    /// @param _proposalID The ID of the proposal to query
    function getState(uint256 _proposalID) public view override returns (ProposalState) {
    ...
    function _propose(
        ...
        require(
            _blockNumber + rocketDAOProtocolSettingsProposals.getProposalMaxBlockAge() > block.number,
            'Block too old'
        );
        // Calculate quorums
        uint256 quorum = 0;
    ...
    function _addProposal(
        ...
        setUint(
            keccak256(abi.encodePacked(daoProposalNameSpace, 'phase1End', proposalID)),
            _startTime + _phase1Duration
        ); // The time the proposal where voting ends on phase 1
        setUint(
            keccak256(abi.encodePacked(daoProposalNameSpace, 'phase2End', proposalID)),
            _startTime + _phase1Duration + _phase2Duration
        ); // The time the proposal where voting ends on phase 2
    ...
    function _vote(address _nodeOperator, uint256 _votes, uint256 _proposalID, VoteDirection _voteDirection) internal {
        ...
        setUint(
            keccak256(abi.encodePacked(daoProposalNameSpace, 'receipt.direction', _proposalID, _nodeOperator)),
            uint256(_voteDirection)
        );
        // Log it
