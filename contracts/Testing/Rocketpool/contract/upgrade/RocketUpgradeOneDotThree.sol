...
contract RocketUpgradeOneDotThree is RocketBase {
    ...
    function execute() external onlyGuardian {
        ...
        _upgradeContract(
            ...
            newRocketDAOProtocolSettingsRewards,
            newRocketDAOProtocolSettingsRewardsAbi
        );
        ...
        _upgradeContract(
            ...
            newRocketDAOProtocolSettingsNetwork,
            newRocketDAOProtocolSettingsNetworkAbi
        );
        _upgradeContract(
            'rocketDAOProtocolSettingsAuction',
            newRocketDAOProtocolSettingsAuction,
            newRocketDAOProtocolSettingsAuctionAbi
        );
        _upgradeContract(
            'rocketDAOProtocolSettingsDeposit',
            newRocketDAOProtocolSettingsDeposit,
            newRocketDAOProtocolSettingsDepositAbi
        );
        _upgradeContract(
            'rocketDAOProtocolSettingsInflation',
            newRocketDAOProtocolSettingsInflation,
            newRocketDAOProtocolSettingsInflationAbi
        );
        _upgradeContract(
            'rocketDAOProtocolSettingsMinipool',
            newRocketDAOProtocolSettingsMinipool,
            newRocketDAOProtocolSettingsMinipoolAbi
        );
        ...
        _addContract(
            ...
            rocketDAOProtocolSettingsProposals,
            rocketDAOProtocolSettingsProposalsAbi
        );
        _addContract(
        ...
        setBool(
            keccak256(
                abi.encodePacked('dao.security.allowed.setting', 'minipool', 'minipool.submit.withdrawable.enabled')
            ),
            true
        );
        setBool(
            keccak256(abi.encodePacked('dao.security.allowed.setting', 'minipool', 'minipool.bond.reduction.enabled')),
            true
        );
        setBool(
            keccak256(abi.encodePacked('dao.security.allowed.setting', 'network', 'network.submit.balances.enabled')),
            true
        );
        setBool(
            keccak256(abi.encodePacked('dao.security.allowed.setting', 'network', 'network.submit.prices.enabled')),
            true
        );
        setBool(keccak256(abi.encodePacked('dao.security.allowed.setting', 'node', 'node.registration.enabled')), true);
        setBool(
            keccak256(
                abi.encodePacked('dao.security.allowed.setting', 'node', 'node.smoothing.pool.registration.enabled')
            ),
            true
        );
        setBool(keccak256(abi.encodePacked('dao.security.allowed.setting', 'node', 'node.deposit.enabled')), true);
        setBool(
            keccak256(abi.encodePacked('dao.security.allowed.setting', 'node', 'node.vacant.minipools.enabled')),
            true
        );
    ...
    function _addContract(string memory _name, address _contractAddress, string memory _contractAbi) internal {
        ...
        require(
            getAddress(keccak256(abi.encodePacked('contract.address', _name))) == address(0x0),
