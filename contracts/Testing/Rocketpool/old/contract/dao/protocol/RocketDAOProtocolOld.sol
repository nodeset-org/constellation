...
contract RocketDAOProtocolOld is RocketBase, RocketDAOProtocolInterfaceOld {
    ...
    function bootstrapSettingMulti(
        ...
        RocketDAOProtocolProposalsInterfaceOld(getContractAddress('rocketDAOProtocolProposals')).proposalSettingMulti(
    ...
    function bootstrapSettingUint(
        ...
        // Ok good to go, lets update the settings
        RocketDAOProtocolProposalsInterfaceOld(getContractAddress('rocketDAOProtocolProposals')).proposalSettingUint(
    ...
    function bootstrapSettingBool(
        ...
        // Ok good to go, lets update the settings
        RocketDAOProtocolProposalsInterfaceOld(getContractAddress('rocketDAOProtocolProposals')).proposalSettingBool(
            _settingContractName,
            _settingPath,
            _value
        );
    ...
    function bootstrapSettingAddress(
        ...
        // Ok good to go, lets update the settings
        RocketDAOProtocolProposalsInterfaceOld(getContractAddress('rocketDAOProtocolProposals')).proposalSettingAddress(
            _settingContractName,
            _settingPath,
            _value
        );
    ...
    function bootstrapSettingClaimer(
        string memory _contractName,
        uint256 _perc
    ) external override onlyGuardian onlyBootstrapMode onlyLatestContract('rocketDAOProtocol', address(this)) {
        // Ok good to go, lets update the rewards claiming contract amount
        RocketDAOProtocolProposalsInterfaceOld(getContractAddress('rocketDAOProtocolProposals'))
    ...
    function bootstrapSpendTreasury(
        ...
        RocketDAOProtocolProposalsInterfaceOld(getContractAddress('rocketDAOProtocolProposals')).proposalSpendTreasury(
            _invoiceID,
            _recipientAddress,
            _amount
        );
